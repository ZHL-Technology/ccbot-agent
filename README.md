...
export CCBOT_AGENT_VERSION="v0.1.7"
...
```text
https://github.com/ZHL-Technology/ccbot-agent/releases/download/v0.1.7/CCBot-Windows-Installer-v0.1.7.exe
```
...
```bash
git tag -a v0.1.7 -m "CCBot Agent v0.1.7"
